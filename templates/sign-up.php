...
<form class="form mt container <?php  if (count($errors)) { print 'form--invalid';} ?>" action="sign-up.php" method="post" autocomplete="off">
    ...
    <div class="form__item <?php if(isset($errors['name'])) { print 'form__item--invalid';} ?>">
        ...
        <span class="form__error"><?php if (isset($errors['name'])) { print $errors['name']; } ?></span>
    </div>
    <div class="form__item <?php if (isset($errors['contacts'])) { print 'form__item--invalid';} ?>">
        ...
        <span class="form__error"><?php if (isset($errors['contacts'])) { print $errors['contacts']; } ?></span>
    </div>
